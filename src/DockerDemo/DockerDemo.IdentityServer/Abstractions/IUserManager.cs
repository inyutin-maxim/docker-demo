...
namespace DockerDemo.IdentityServer.Abstractions
{
    public interface IUserManager
    {
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> AddClaimsAsync(IdentityUser user,
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> AddLoginAsync(IdentityUser user,
											UserLoginInfo login);
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> AddPasswordAsync(IdentityUser user,
											string password);
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> AddToRolesAsync(IdentityUser user,
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> ChangeEmailAsync(IdentityUser user,
											string newEmail,
											string token);
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> ChangePasswordAsync(IdentityUser user,
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> ChangePhoneNumberAsync(IdentityUser user,
													string phoneNumber,
													string token);
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> ConfirmEmailAsync(IdentityUser user,
												string token);
		...
		Task<int> CountRecoveryCodesAsync(IdentityUser user);
		...
		Task<byte[]> CreateSecurityTokenAsync(IdentityUser user);
		...
		/// </returns>
		Task<string> GenerateChangePhoneNumberTokenAsync(IdentityUser user,
														string phoneNumber);
		...
		Task<IEnumerable<string>> GenerateNewTwoFactorRecoveryCodesAsync(IdentityUser user,
																		int number);
		...
		Task<string> GetAuthenticationTokenAsync(IdentityUser user,
		...
		/// <returns>
		/// A <see cref="T:System.Threading.Tasks.Task`1" /> that represents the result of the asynchronous query, a list of <typeparamref name="IdentityUser" />s who
		...
		Task<IdentityResult> RedeemTwoFactorRecoveryCodeAsync(IdentityUser user,
															string code);

		/// <summary>Registers a token provider.</summary>
		/// <param name="providerName">The name of the provider to register.</param>
		/// <param name="provider">The provider to register.</param>
		void RegisterTokenProvider(string providerName,
									IUserTwoFactorTokenProvider<IdentityUser> provider);
		...
		Task<IdentityResult> RemoveAuthenticationTokenAsync(IdentityUser user,
															string loginProvider,
															string tokenName);
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> RemoveClaimsAsync(IdentityUser user,
												IEnumerable<Claim> claims);
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> RemoveFromRoleAsync(IdentityUser user,
												string role);
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> RemoveFromRolesAsync(IdentityUser user,
												IEnumerable<string> roles);
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> RemoveLoginAsync(IdentityUser user,
											string loginProvider,
											string providerKey);
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> ReplaceClaimAsync(IdentityUser user,
												Claim claim,
												Claim newClaim);
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> ResetPasswordAsync(IdentityUser user,
												string token,
												string newPassword);
		...
		/// <returns>Whether the user was successfully updated.</returns>
		Task<IdentityResult> SetAuthenticationTokenAsync(IdentityUser user,
														string loginProvider,
														string tokenName,
														string tokenValue);
		...
		/// </returns>
		Task<IdentityResult> SetLockoutEnabledAsync(IdentityUser user,
													bool enabled);
		...
		/// <returns>The <see cref="T:System.Threading.Tasks.Task" /> that represents the asynchronous operation, containing the <see cref="T:Microsoft.AspNetCore.Identity.IdentityResult" /> of the operation.</returns>
		Task<IdentityResult> SetLockoutEndDateAsync(IdentityUser user,
		...
		/// of the operation.
		/// </returns>
		Task<IdentityResult> SetPhoneNumberAsync(IdentityUser user,
												string phoneNumber);
		...
		/// The <see cref="T:System.Threading.Tasks.Task" /> that represents the asynchronous operation, the <see cref="T:Microsoft.AspNetCore.Identity.IdentityResult" /> of the operation
		/// </returns>
		Task<IdentityResult> SetTwoFactorEnabledAsync(IdentityUser user,
													bool enabled);
		...
		Task<IdentityResult> SetUserNameAsync(IdentityUser user,
											string userName);
		...
		/// </returns>
		Task<bool> VerifyChangePhoneNumberTokenAsync(IdentityUser user,
													string token,
													string phoneNumber);
		...
		/// otherwise false.
		/// </returns>
		Task<bool> VerifyTwoFactorTokenAsync(IdentityUser user,
											string tokenProvider,
											string token);
		...
		/// is valid, otherwise false.
		/// </returns>
		Task<bool> VerifyUserTokenAsync(IdentityUser user,
										string tokenProvider,
										string purpose,
										string token);
    }
